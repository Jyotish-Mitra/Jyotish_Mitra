...
Is data ke aadhar par Hindi mein vistrit jyotish prediction do.`;
    ...
    // Gemini kabhi-kabhi 503 (high demand / temporary overload) deta hai.
    // Isliye 3 baar tak retry karte hain, beech mein thoda wait karke.
    let response;
    let lastErrText = "";
    const maxAttempts = 3;
    ...
    for (let attempt = 1; attempt <= maxAttempts; attempt++) {
      ...
      // Thoda wait karke retry - 1s, fir 2s
